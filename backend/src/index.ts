...
<section class="wrap" style="padding-top:24px;">
  ...
  <p class="sub">66 controls across performance, gaming, privacy, maintenance and interface. Every change snapshots the original value first, so nothing is a one-way door.</p>
  <p style="margin-top:28px;">
    <a class="btn-primary" href="${primaryHref}">&#8681; Download for Windows${versionLabel}</a>
  </p>
  <p style="color:#8b87a0; font-size:14px;">Windows 10/11, 64-bit &middot; 39 Free controls &middot; also on <a href="https://winstall.app/apps/AurelioAvila.PCTweaker">winget</a></p>
</section>
...
<section class="wrap" id="pricing">
  ...
  <h2>39 Free controls, forever</h2>
  ...
  <div class="grid2" style="margin-top:28px;grid-template-columns: repeat(auto-fit, minmax(240px,1fr));">
    <div class="price-card"><span class="pill">Free</span><div class="price">&euro;0</div><p style="color:#b7b3c9;font-size:14px;">39 controls, forever. No account required.</p></div>
    <div class="price-card pro"><span class="pill">Monthly</span><div class="price">&euro;9.99<span style="font-size:14px;font-weight:400;color:#8b87a0;">/mo</span></div><p style="color:#b7b3c9;font-size:14px;">All 66 controls (39 Free and 27 Pro) and presets.</p></div>
