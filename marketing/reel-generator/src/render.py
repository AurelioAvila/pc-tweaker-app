...
def _load_voice_clip(audio_path: str):
    """Carica l'mp3 della voce con un margine di sicurezza in coda.

    FIX (2026-08-23, misurato su ghostcut-youtube-bot/youtube-bot/
    shopify-dropship-bot/certsprint-youtube-bot/solofounded-bot, stesso
    ...
    if audio.duration > safety_margin * 2:
        audio = audio.subclip(0, audio.duration - safety_margin)
    return audio
...
def render_short(background_video_paths, audio_path: str, word_timings: list, output_path: str, hook: str = None, caption_end_word: int | None = None, caption_text: str | None = None, preserve_landscape: bool = False, show_captions: bool = True):
    ...
    audio = _load_voice_clip(audio_path)
