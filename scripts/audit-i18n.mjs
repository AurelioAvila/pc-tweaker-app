...
const REVIEWED_AS_CORRECT = new Set([
  ...
  "de:scan.formDesktop",
  "pt:scan.formDesktop",
  "it:hardware.winUpdateLabel",
  "fr:hardware.winUpdateLabel",
  "es:hardware.winUpdateLabel",
  "de:hardware.winUpdateLabel",
  "pt:hardware.winUpdateLabel",
