...
export const engDictionary: Dictionary = {
  ...
  hero: {
    ...
    title2: "MILLISECOND",
    title3: "IS EARNED.",
    subBold: "42 real Windows tweaks",
  ...
  metrics: {
    ...
    stats: [
      ...
      { value: 42, unit: "", label: "REAL SYSTEM TWEAKS" },
  ...
  arsenal: {
    ...
    cards: [
      ...
      },
      {
        ...
        body: "Before any tweak writes a single registry value, its previous state is captured. Revert one tweak, or all 42 at once with Restore All. Optimization you can walk back from — that is the entire premise.",
        pro: false,
        span: "wide",
      },
      {
  ...
  pricing: {
    ...
    free: {
      ...
      per: "/ forever",
      features: [
        "28 real tweaks across every domain",
