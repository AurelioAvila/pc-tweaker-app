...
export const engDictionary: Dictionary = {
  ...
  "hero": {
    ...
    "safetyNote": "PC Tweaker 1.10.2 is code-signed. Our signed Windows installers identify Aurelio Avila as the publisher. Older downloads may be unsigned; check the file's Digital Signatures tab. SmartScreen may still show a warning for a new release.",
