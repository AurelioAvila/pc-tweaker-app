export const PRACTICAL_GUIDES = {
  ...
  "/what-pc-tweaker-changes": {
    ...
    sections: [
      ...
      { heading: "Free features and signed installers", body: "The current release includes 37 Free tweaks out of 61 in the catalogue, plus editable starter profiles, with no account required. Pro adds paid tools and automatic game sessions. Official Windows installers are digitally signed by Aurelio Avila. Signing identifies the publisher and protects file integrity; it does not guarantee that SmartScreen or antivirus warnings will never appear." },
